...
public sealed class AsyncRelayCommand : AsyncDelegateCommand
{
    public AsyncRelayCommand(Func<Task> executeMethod) : base(executeMethod)
    {
    }

    public AsyncRelayCommand(Func<CancellationToken, Task> executeMethod) : base(executeMethod)
    {
    }

    public AsyncRelayCommand(Func<Task> executeMethod, Func<bool> canExecuteMethod) : base(executeMethod, canExecuteMethod)
    {
    }

    public AsyncRelayCommand(Func<CancellationToken, Task> executeMethod, Func<bool> canExecuteMethod) : base(executeMethod, canExecuteMethod)
    {
    }
}
